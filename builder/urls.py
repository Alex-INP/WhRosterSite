...
from .views import RosterListView, DisplayRosterListView, FactionUnitsListView, CreateRosterView, \
    ManageRosterListView, RosterDeleteView
...
urlpatterns = [
    ...
    path("delete_roster/<int:pk>", RosterDeleteView.as_view(), name="delete_roster"),
]
